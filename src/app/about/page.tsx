        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-5 text-white/60 leading-relaxed">
              ...
              <p>
                Privacy is foundational, not a feature. The survey collects no names,
                no employer names, and requires no email to submit. IP addresses are
                hashed for duplicate detection and never stored in their original form.
                Data is only ever displayed in aggregate with strict minimum thresholds.
                The architecture minimizes identifying information by design &mdash;
              ...
              <p>
                ...
                executives, journalists. If this project disappears tomorrow, the data
